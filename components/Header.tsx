...
export default function Header() {
    ...
    return (
        <>
            <nav className="fixed top-0 z-[100] w-full h-20 md:h-28 flex items-center justify-between px-4 md:px-12 py-0 glass border-b-4 border-accent transition-all duration-500">
                {/* Logo */}
